...
exports.getProxy = exports.getMockState = exports.track = exports.configure = void 0;
var react_native_1 = require("react-native");
var DEFAULT_OPTIONS = {
    server: react_native_1.Platform.select({
...
function getMockState() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(options.server + "/getMockState", {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json"
                        }
